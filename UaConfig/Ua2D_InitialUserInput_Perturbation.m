...
CtrlVar.dt=1e-3; CtrlVar.TotalNumberOfForwardRunSteps=1;
CtrlVar.time=0;
CtrlVar.ResetTime=0;
...
%%
if strfind(UserVar.Experiment,'Calving')
...
CtrlVar.Cmin=1.0000e-100;
CtrlVar.Cmax=1.0000e+100;
...
CtrlVar.Inverse.Regularize.logC.ga=UserVar.Inverse.ga;
...
CtrlVar.Inverse.Regularize.logAGlen.ga=UserVar.Inverse.ga;
